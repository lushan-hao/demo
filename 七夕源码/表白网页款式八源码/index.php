...
<meta name="description" content="51bbw.cn 我要表白网  2014年7月25日成立。附有免费的表白网页一键式生成系统，精美简约的表白模版，可自定义加入图片音乐文字等内容。永久保存您的表白信息，记录您和TA的故事。我们的口号是： 为爱情中得小惊喜而感动" />
	<title>阿狸表白网页自动生成程序 - 51bbw.cn 我要表白网 - 情人节,表白程序,表白源码,自动表白程序,表白网页制作</title>
...
<body>
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				...
				<p>51bbw.cn 我要表白网</p>为您终身免费提供表白网页访问服务，没有最好，只有更好！</p>您只要牢记我们的情人表白专用域名：我要表白网（51bbw.cn）</p>只要在本页将所有表白的文字改成您自己对爱人的表白文字，然后点保存生成属于您独一无二专有的个人表白网页！</p>只要记住您专属的表白网页网址，在全世界能上网的地方就能看到您的爱情表白誓言！</p>是不是心动了？那就来试试效果吧！！</p>(这里字可以忽略，生成网页不会有！)</p>
			</div>
	...
	<div class="write-ok">
		<div class="write-box">
			...
			<p><small><a href="http://ymjzy.net/1103.html" target="_blank">不会填写了？点击这里看一下教程吧！</a></small></p>
			<p id="write-url">自定义表白链接：<u>http://51bbw.cn/love/2015/</u><span id="text-href" contenteditable="true"><?php echo time(); ?></span><i></i><u>.html</u></p>
